...
// Copy of the function from server.js
...
async function test() {
  const testUrls = [
    ...
    'https://www.youtube.com/shorts/dQw4w9WgXcQ' // Assuming this is a valid ID format
  ];
  ...
  for (const url of testUrls) {
    ...
    console.log(`${url} -> ${id}`);
    if (id !== 'dQw4w9WgXcQ') {
      console.error('FAILED extraction for', url);
    }
  }

  console.log('\nTesting Video Fetching (Rick Roll):');
  try {
